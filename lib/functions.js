...
const banner = cfonts.render(('Pinky|Bot'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","yellow"],
...
module.exports = { wait, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, sleep, close}
