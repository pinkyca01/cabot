...
「 *PINKY BOT* 」`
            ...
            case 'bahasa':
               ...
               nuy.sendMessage(from, bahasa(prefix), MessageType.text, {quoted: ftroli})
               break
            case 'donasi':
            case 'donate':
               nuy.sendMessage(from, donasi(name), MessageType.text, {quoted: ftroli})
               break
            case 'info':
               me = nuy.user
               user.push(sender)
            ...
            case 'fitnah':
               ...
               var bot = gh.split('/')[2]
               nuy.sendMessage(from, `${bot}`, MessageType.text, { quoted: { key: { fromMe: false, participant: `${mentioned}`, ...(from ? { remoteJid: from } : {}) }, message: { conversation: `${target}` } } })
               break
